...
#define STM32F10X_MD_VL  /*!< STM32F10X_MD_VL: STM32 Medium density Value Line devices */  /* I changed here, choosing a board */
 ...
 * @brief Comment the line below if you will not use the peripherals drivers.
   ...
   */
#define USE_STDPERIPH_DRIVER /* I changed here */
#endif
